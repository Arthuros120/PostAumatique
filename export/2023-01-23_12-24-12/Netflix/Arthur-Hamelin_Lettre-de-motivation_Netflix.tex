...
\setkomavar{subject}{Objet :  Candidature pour un stage de 10 semaines dans le développement ou la maintenance applicative au sein de l’entreprise Netflix.}
...
Je pense que Netflix est une entreprise innovante et dynamique qui offre de nombreuses possibilités d'apprentissage et de développement. C'est pourquoi je serais très heureux de travailler au sein de votre entreprise et de contribuer à la mise en œuvre de projets informatiques innovants. Je suis sûr que ce stage sera riche en enseignements et en défis stimulants.
