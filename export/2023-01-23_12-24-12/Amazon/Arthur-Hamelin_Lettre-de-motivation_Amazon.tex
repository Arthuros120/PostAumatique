...
\setkomavar{subject}{Objet :  Candidature pour un stage de 10 semaines dans le développement ou la maintenance applicative au sein de l’entreprise Amazon.}
...
Travailler au sein d'Amazon me permettrait d'accéder à une expérience professionnelle très enrichissante et de développer mes compétences en informatique. De plus, Amazon est une entreprise très respectée et reconnue pour sa qualité de service et ses produits innovants. Je serais donc très honoré de pouvoir intégrer votre entreprise et de contribuer à son développement.
